...
class Pokemon:
    ...
    def weakness(self, pk_a, otherpokemon):
        # ERROR IS HERE!
        print(self.types[0].upper(), otherpokemon.types[0].upper())
        print(pk_a[self.types[0].upper()][otherpokemon.types[0].upper()])
...
print(Pokemon1.weakness(pk_a, Pokemon2))
print(Pokemon2.weakness(pk_a, Pokemon1))
