...
class Pokemon:
    ...
    def fighthing(self, opok):
        ...
        print("\nOPOK ", opok.attackpoke, opok.attackpoke / self.hdivider)
        print("SELF ", self.attackpoke, self.attackpoke / opok.hdivider)

        # if round(opok.attackpoke / self.hdivider) != 0:
        #     self.bars = self.bars[:-int(round(opok.attackpoke / self.hdivider))]
        # else:
        #     self.bars = self.bars
